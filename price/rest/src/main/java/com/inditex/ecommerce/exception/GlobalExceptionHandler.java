...
import static com.inditex.ecommerce.exception.Error.missingOrInvalidDataInRequest;
import static com.inditex.ecommerce.exception.Error.validationError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleException(Exception ex){
        log.error("Exception during handling request" , ex);
    ...
    public ResponseEntity<Object> handleAll(MissingRequestValueException ex){
        ApiError apiError = ApiError.builder()
                ...
                .message( ex.getMessage())
                .errors(Arrays.asList(validationError()))
                .timestamp(LocalDateTime.now())
                .build();
